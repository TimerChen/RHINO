...
HML_LOWER_JOINT_NAMES = ['pelvis', 'left_hip', 'right_hip', 'left_knee', 'right_knee', 'left_ankle', 'right_ankle', 'left_foot', 'right_foot',]
HML_UPPER_JOINT_NAMES = ['pelvis'] + [name for name in HML_JOINT_NAMES if name not in HML_LOWER_JOINT_NAMES]
HML_ARM_JOINT_NAMES = ['left_shoulder', 'right_shoulder', 'left_elbow', 'right_elbow', 'left_wrist', 'right_wrist']
...
HML_ARM_JOINTS = [HML_JOINT_NAMES.index(name) for name in HML_ARM_JOINT_NAMES]
SMPL_ARM_JOINTS = HML_ARM_JOINTS + [22, 23]
